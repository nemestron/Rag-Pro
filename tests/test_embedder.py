...
def sample_chunks():
    ...
    return [
        Document(page_content="Python is a highly popular programming language.", metadata={"id": 1}),
        Document(page_content="The capital of France is Paris.", metadata={"id": 2}),
        Document(page_content="Photosynthesis is the process used by plants to make food.", metadata={"id": 3})
    ]
