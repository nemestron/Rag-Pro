...
def test_load_urls_valid(mock_load):
    ...
    mock_load.return_value = [Document(page_content="Mock web content", metadata={"source": "https://example.com"})]
...
def test_load_all_sources_empty():
    with pytest.raises(ValueError, match="No valid document content could be extracted"):
        load_all_sources()
