...
def short_document():
    # 45 characters long
    return [Document(page_content="This is a short document that fits in a chunk.", metadata={"source": "short.txt"})]
...
def long_document():
    ...
    return [Document(page_content=text, metadata={"source": "long.txt", "author": "Engineer"})]
