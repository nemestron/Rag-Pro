...
def validate_grounding():
    ...
    for q in out_of_context_qs:
        ...
        if (
            "I don't have enough information" in ans
            or "I do not have enough information" in ans
        ):
    ...
    print("\n" + "=" * 60)
    print(
        f"GROUNDING ACCURACY: {accuracy}% ({passed_refusals}/{len(out_of_context_qs)} refused correctly)"
    )
    if accuracy >= 90:
